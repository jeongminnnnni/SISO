  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell: 'text-gray-500 rounded-md w-full text-center font-normal text-[0.8rem]',
        ...
        day_outside: 'text-gray-400 opacity-50 aria-selected:bg-gray-100/50 aria-selected:text-gray-500',
